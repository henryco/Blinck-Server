...
public class Details {
	...
	public static class Type {
		...
		public static
		Type newMaleFem(Integer dimension) {
			return new Type(MALE, FEMALE, dimension);
		}

		public static
		Type newFemMale(Integer dimension) {
			return new Type(FEMALE, MALE, dimension);
		}

		public static
		Type newMaleMale(Integer dimension) {
			return new Type(MALE, MALE, dimension);
		}

		public static
		Type newFemFem(Integer dimension) {
			return new Type(FEMALE, FEMALE, dimension);
		}

		public static
		Type newBoth(Integer dimension) {
